	...
	<div class="main">
		...
		<div id="cont">
			<div class="centent">
				<div class="left">
					<ul class="baseUI">
						<li url="toAddCategory.action"><a href="#"> <em class="base_basicset"></em><span>添加栏目</span>
						</a></li>
						<li url="toCategoryManager.action"><a href="#"> <em class="base_userset"></em><span>栏目管理</span>
						</a></li>
						<li url="toAddNews.action"><a href="#"> <em class="base_roll"></em><span>新闻发布</span>
						</a></li>
						<li url="toNewsManager.action"><a href="#"> <em class="base_sys"></em><span>新闻管理</span>
						</a></li>
					</ul>
				</div>
